...
def help():
    ...
    stdout.write("             "+Fore.RED            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"exit     "+Fore.RED+"|"+Fore.LIGHTWHITE_EX+" Exit INSPEKTORS DDoS                        "+Fore.RED+"║\n")
    stdout.write("             "+Fore.RED            +"╠═════════════════════════════════════════════════════╣\n")
    stdout.write("             "+Fore.RED            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"THANK    "+Fore.RED+"|"+Fore.LIGHTWHITE_EX+" Thanks for using INSPEKTORS.                "+Fore.RED+"║\n")
...
def title():
    ...
    stdout.write("             "+Fore.RED            +"        ══╦═════════════════════════════════╦══\n")
    stdout.write("             "+Fore.RED+"╔═════════╩═════════════════════════════════╩═════════╗\n")
    stdout.write("             "+Fore.RED+"║ "+Fore.LIGHTWHITE_EX   +"        Welcome To The Main Screen Of Inspektors BOOT  "+Fore.RED  +"       ║\n")
    stdout.write("             "+Fore.RED+"║ "+Fore.LIGHTWHITE_EX   +"          Type [help] to see the Commands    "+Fore.RED +"       ║\n")
    stdout.write("             "+Fore.RED+"║ "+Fore.LIGHTWHITE_EX   +"         Contact Dev - Telegram @zjfoq394   "+Fore.RED +"        ║\n")
    stdout.write("             "+Fore.RED+"╚═════════════════════════════════════════════════════╝\n")
    stdout.write("\n")
##############################################################################################
def command():
    stdout.write(Fore.RED+"╔═══"+Fore.RED+"[""root"+Fore.LIGHTGREEN_EX+"@"+Fore.RED+"inspektors"+Fore.CYAN+"]"+Fore.RED+"\n╚══\x1b[38;2;0;255;189m> "+Fore.WHITE)
    command = input()
